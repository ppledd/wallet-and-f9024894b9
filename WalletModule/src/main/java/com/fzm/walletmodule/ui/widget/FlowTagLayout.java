...
public class FlowTagLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0, childCount = getChildCount(); i < childCount; i++) {
            ...
            if (mGroupMode != -1) {
                if ((i + 1) % mGroupMode == 0) {
                    childLeft += ScreenUtils.dp2px(getContext(), 14);
                }
            }
                    ...
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        ...
                        if (mCheckedTagArray.get(j)) {
                            ...
                            if (mOnTagSelectListener != null) {
                                mOnTagSelectListener.onItemSelect(FlowTagLayout.this, new ArrayList<Integer>(), j, false);
                            }
                            return;
                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(FlowTagLayout.this, Arrays.asList(j), j, true);
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        ...
                        if (mOnTagSelectListener != null) {
                            ...
                            mOnTagSelectListener.onItemSelect(FlowTagLayout.this, list, j, selected);
                        }
                    }
                }
            });
    ...
    public interface OnTagSelectListener {
        void onItemSelect(FlowTagLayout parent, List<Integer> selectedList, int position, boolean isSelect);
    }
}
